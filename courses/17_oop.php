...
===============================
  ...
  From PHP5+ you can write PHP in either a procedural 
...
class User
{
  ...
  */
  ...
  from the class. We pass in the properties to the constructor 
  from the outside. 
  */
  ...
  {
    /* 
    We assign the properties passed in from the outside 
    to the properties we created inside the class. 
    */
  ...
  function __destruct()
  {
    echo "<br>" . "FROM __destruct :" . "<br/>" . "The user name is {$this->name} <br />";
  }
}
...
/*
  ...
  It is achieved by creating a new class that 'extends' 
  an existing class.
*/
