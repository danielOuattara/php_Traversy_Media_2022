<?php
/* This is a php tag. If there is no html or other content 
below the php, we don't need to close the php tag.*/
...
// If there is more content after the PHP, such as this 
// file, you do need the ending tag. Otherwise you do not.
?>
...
<body>
  ...
  <!-- You may only drop the semi-colon after a statement when 
  the statement is followed immediately by a closing PHP tag ?>. -->
